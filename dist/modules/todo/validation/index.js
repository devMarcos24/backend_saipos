        ...
        switch (_context.prev = _context.next) {
          case 0:
            schema = _joi["default"].object({
              name: _joi["default"].string().required("title is required"),
              email: _joi["default"].string().required("Email is required"),
              description: _joi["default"].string().required("description is required"),
              status: _joi["default"].string().required("status is required"),
